...
class SoMedia_Settings {
	...
	function save() {
		...
		if (isset($_POST['submit'])) {
				...
				if($_POST['method']=='save'){
					...
					$create = json_decode(file_get_contents("http://partners.somedia.net/wordpress/embedded_create_user?auth=b1477d3e885d44c03e164f26bf7b14ef&email=".$_POST['somedia_username']."&pass=".$_POST['somedia_password'].""),true);
	...
	function options_page() {
		...
		<p class="logo"><img src="<? echo plugins_url( 'logo_somedia.png' , __FILE__ ); ?>"></p>
